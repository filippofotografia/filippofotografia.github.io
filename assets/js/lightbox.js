...
if (gallery) {
  ...
  lightbox.on("uiRegister", () => {
    lightbox.pswp.ui.registerElement({
      name: "toggle-caption-button",
      order: 9,
      isButton: true,
      html: {
        isCustomSVG: true,
        inner: '<path d="M16 10c-5.5 0-9.5 4.5-11 6 1.5 1.5 5.5 6 11 6s9.5-4.5 11-6c-1.5-1.5-5.5-6-11-6Zm0 10a4 4 0 1 1 0-8 4 4 0 0 1 0 8Zm0-2a2 2 0 1 0 0-4 2 2 0 0 0 0 4Z" id="pswp__icn-eye"/>',
        outlineID: "pswp__icn-eye",
      },
      title: "Mostra/nascondi informazioni",
      onClick: (event, el, pswp) => {
        pswp.element.classList.toggle("pswp--caption-hidden");
      },
    });
  });
